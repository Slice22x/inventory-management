...
-- AddForeignKey
ALTER TABLE "ExpenseByCategory" ADD CONSTRAINT "ExpenseByCategory_expenseSummaryId_fkey" FOREIGN KEY ("expenseSummaryId") REFERENCES "ExpensesSummary"("expenseSummaryId") ON DELETE RESTRICT ON UPDATE CASCADE;
